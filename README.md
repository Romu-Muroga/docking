# Docking
## 概要
好きなもの（ver.飲食店）をランキング形式で投稿して共有するアプリ
## コンセプト
このアプリは、お気に入りの飲食店のメニューを投稿し共有する場所を提供することを目的として作られた、食に特化したソーシャルメディアです。
...
食べることが好きな人が勧めるメニューベスト３が一冊にまとめられていて、まるで架空のレストランDockingのメニューを見ているような、そんな体験をユーザーに提供します。  
